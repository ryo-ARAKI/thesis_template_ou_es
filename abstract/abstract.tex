...
\begin{wrapfigure}{r}{12zw}
  ...
  \vspace*{-1zh} % 本文との間隔を調整するために\vspaceに適当な値（1zhは1行分，ptで指定もできる）を入れる
\end{wrapfigure}
...
私は，〇〇〇という問題に注目し~\cite{Goto2017a,GotoJPS2018}，図~\ref{fig:fig_result}のように〜〜〜を明らかにした~\cite{Araki_master_thesis}．% 2022年度からFig.ではなく図に統一することになった．
